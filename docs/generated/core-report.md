...
| `hooks/useProfileData.js` | wirker_profiles | SELECT | 125 |
...
| `services/db.js` | profiles | SELECT | 61 |
| `services/db.js` | profiles | SELECT | 68 |
| `services/db.js` | profiles | UPDATE | 75 |
| `services/db.js` | profiles | UPSERT | 88 |
| `services/db.js` | profiles | SELECT | 99 |
| `services/db.js` | profiles | SELECT | 108 |
| `services/db.js` | wirker_profiles | SELECT | 151 |
| `services/db.js` | wirker_profiles | SELECT | 159 |
| `services/db.js` | wirker_profiles | SELECT | 165 |
| `services/db.js` | wirker_profiles | UPDATE | 174 |
| `services/db.js` | wirker_profiles | INSERT | 189 |
| `services/db.js` | impact_votes | SELECT | 501 |
| `services/db.js` | impact_votes | SELECT | 520 |
| `services/db.js` | impact_votes | INSERT | 537 |
| `services/db.js` | profiles | SELECT | 662 |
