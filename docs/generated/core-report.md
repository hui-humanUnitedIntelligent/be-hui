...
| `pages/MyBasisProfile.jsx` | profiles | UPDATE | 547 |
...
| `services/db.js` | profiles | SELECT | 60 |
| `services/db.js` | profiles | SELECT | 67 |
| `services/db.js` | profiles | UPDATE | 74 |
| `services/db.js` | profiles | UPSERT | 87 |
| `services/db.js` | profiles | SELECT | 98 |
| `services/db.js` | profiles | SELECT | 107 |
| `services/db.js` | wirker_profiles | SELECT | 150 |
| `services/db.js` | wirker_profiles | SELECT | 158 |
| `services/db.js` | wirker_profiles | SELECT | 164 |
| `services/db.js` | wirker_profiles | UPDATE | 173 |
| `services/db.js` | wirker_profiles | INSERT | 188 |
| `services/db.js` | impact_votes | SELECT | 572 |
| `services/db.js` | impact_votes | SELECT | 591 |
| `services/db.js` | impact_votes | INSERT | 608 |
| `services/db.js` | profiles | SELECT | 733 |
