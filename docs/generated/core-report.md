...
| `services/db.js` | wirker_profiles | SELECT | 175 |
| `services/db.js` | wirker_profiles | SELECT | 183 |
| `services/db.js` | wirker_profiles | SELECT | 189 |
| `services/db.js` | wirker_profiles | UPDATE | 198 |
| `services/db.js` | wirker_profiles | INSERT | 213 |
| `services/db.js` | impact_votes | SELECT | 497 |
| `services/db.js` | impact_votes | SELECT | 516 |
| `services/db.js` | impact_votes | INSERT | 533 |
| `services/db.js` | profiles | SELECT | 658 |
