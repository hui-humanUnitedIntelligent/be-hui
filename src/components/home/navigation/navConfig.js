...
//   creator  → switchTab("creator")        — MyBasisProfile, gleiche AppShell wie andere Tabs
//
...
// Tabs die echte Seiten sind (alle vier Haupttabs + Favoriten)
export const PAGE_TABS = ["feed", "discover", "impact", "creator"];

// Overlay-Tabs (öffnen eigene Systeme, kein Tab-Switch) — Orb only
