...
// TAB STRUCTURE: Home / Entdecken / Mein HUI (Orb) / Impact / Profil
// NAV.1A Audit: feed     = globaler Community-Stream     → Label "Home"       (Position 1, links)
//               discover = strukturierter Sektions-Browse → Label "Entdecken" (Position 2, rechts)
//
...
export const NAV_ITEMS = filterValidPages([
  createNavItem({ key: "feed",      label: "Home"      }),  // UnifiedFeed — Community-Stream
  createNavItem({ key: "discover",  label: "Entdecken" }),  // DiscoverPage — strukturierter Browse
