...
/** CSS calc for floating controls above the navigation. */
export const FLOATING_ABOVE_NAV_BOTTOM = `calc(${NAV_CONTENT_H + 20}px + max(${SAFE_B}px, env(safe-area-inset-bottom, ${SAFE_B}px)))`;
