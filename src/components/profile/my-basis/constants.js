// src/components/profile/my-basis/constants.js
// Shared constants, design tokens, and helpers for MyBasisProfile.
...
export const FB_AVT = FB_AVATAR; // Alias fuer FB_AVATAR aus profileMedia.js
