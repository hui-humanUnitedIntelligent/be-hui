...
import MyRecommendationsContent from "../../features/resonance/foundation/components/MyRecommendationsContent.jsx";
...
// MyRecommendationsModal — Meine Empfehlungen (Shell um gemeinsame Content-Komponente)
  ...
  return createPortal(
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ overflowY:"auto", WebkitOverflowScrolling:"touch", flex:1 }}>
          <MyRecommendationsContent userId={userId} onClose={onClose} />
        </div>
      </div>
    </div>,
    document.body
