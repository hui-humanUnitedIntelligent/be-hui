    ...
    >
      <div style={{ display:"flex", alignItems:"flex-start", gap:12, padding:"12px 14px" }}>
        ...
        <div style={{ flex:1, minWidth:0 }}>
          ...
          {isSupport && (
            <button
              onClick={e => { e.stopPropagation(); if (!n.is_read) onRead?.(n.id); setShowSupportModal(true); }}
              style={{
                marginTop:8, padding:"5px 12px",
                borderRadius:99, border:"1.5px solid rgba(14,196,184,0.4)",
                background:"rgba(14,196,184,0.08)", color:"#0EC4B8",
                fontSize:11, fontWeight:700, cursor:"pointer",
                fontFamily:"inherit", display:"inline-flex",
                alignItems:"center", gap:5,
              }}
            >
              <span>🎧</span> Antwort lesen
            </button>
          )}
