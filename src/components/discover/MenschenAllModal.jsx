...
// DISCOVER-CLEAN-001 (2026-09-15, Michael-Report 20467c2f): Verbinden- +
// Folgen-Buttons UND "Folge ich"-Badge von den Menschen-Karten ENTFERNT --
// "sieht nicht gut aus ... nur die Herzen da sind". Folgen/Verbinden bleibt
// erreichbar ueber Kartentipp -> volles Profil (RelationButtons dort).
  ...
  return (
    <div onClick={() => onPress?.(p)} style={{
      ...
      {/* Follower + Likes — immer nebeneinander in 1 Zeile.
          DISCOVER-CLEAN-001: "✓ Folge ich"-Badge (PUNKT1-FOLLOWING-BADGE)
          und Folgen/Verbinden-Buttons entfernt — nur die Statistik-Pills
          bleiben (Michaels "nur die Herzen da sind"). */}
