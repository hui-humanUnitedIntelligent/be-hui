...
/* 62. Löschen / Papierkorb (DELETE-MODAL-REDESIGN, 2026-08-29, Michael-Feedback:
   "Löschen modal sieht furchtbar aus" — ersetzt rohe Emoji 🗑 in allen
   Löschen-Bestätigungen durch konsistentes SSOT-Icon, gleicher Outline-Stil
   wie alle anderen HUI-Icons dieser Datei, kein Emoji/Clipart. */
export function HUITrashIcon({ size = 24, className, style }) {
  return (
    <Icon size={size} className={className} style={style} title="Löschen">
